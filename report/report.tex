...
These tests do not provide info about the performance of the whole database.
...
On the other hand, figure \ref{fig:unique_increasing_insert} and \ref{images/nonunique_random_insert.pdf} show that even in the best case inserting is slower with prefix-sharing.
