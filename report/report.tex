...
% * random is the worst case scenario
% * show worst case if we are better, best case if we are worse
% * search is searching each element
% * non-unique tree is 10 times duplication
% * non-unique increasing does not make any sense
% 
% * insert unique random same amount of nodes ("unique-random-insert-numNodes")
% * insert nonunique-random or increasing much less nodes ("nonunique-random-insert-numNodes"), 
%     * "unique-increasing-insert", "non-unique-increasing-insert"
% * insert unique/nonunique takes more time, even for the increasing  
%     * best case: "non-unique-increasing-insert"
% 
% * write takes almost double the time
%     * show only for the type where we have the best node difference "non-unique-increasing-insert"
% 
% * search? our index worse for nonUniqueIndex-increasing? certainly worse for unique-random, unique increasing worse as well (WHY?),  
% 
% * after remove our tree is more balanced (random, unique, because that was before not so well balanced)
%     * time of delete not so good
\begin{figure}
    \begin{minipage}{0.45\textwidth}
    \centering
	\includegraphics[scale=0.37]{images/unique_random_insert_numNodes.pdf} 
    \caption{unique random insert numNodes}
	\end{minipage}
	\hspace{0.5cm}
	\begin{minipage}{0.45\textwidth}
	\centering
...
\begin{figure}
    \begin{minipage}{0.45\textwidth}
    \centering
	\includegraphics[scale=0.37]{images/unique_increasing_insert_numNodes.pdf} 
    \caption{unique increasing insert numNodes}
	\end{minipage}
	\hspace{0.5cm}
	\begin{minipage}{0.45\textwidth}
	\centering
	\includegraphics[scale=0.37]{images/nonunique_random_insert_numNodes.pdf} 
    \caption{nonunique random insert numNodes}
	\end{minipage}
\end{figure}
...
\begin{figure}
    \begin{minipage}{0.45\textwidth}
    \centering
	\includegraphics[scale=0.37]{images/unique_increasing_insert.pdf} 
    \caption{unique increasing insert duration}
	\end{minipage}
	\hspace{0.5cm}
	\begin{minipage}{0.45\textwidth}
	\centering
	\includegraphics[scale=0.37]{images/nonunique_random_insert.pdf} 
    \caption{nonunique random insert duration}
	\end{minipage}
\end{figure}
...
\begin{figure}
    \begin{minipage}{0.45\textwidth}
    \centering
	\includegraphics[scale=0.37]{images/unique_increasing_write.pdf} 
    \caption{unique increasing write}
	\end{minipage}
	\hspace{0.5cm}
	\begin{minipage}{0.45\textwidth}
	\centering
	\includegraphics[scale=0.37]{images/nonunique_random_search.pdf} 
    \caption{nonunique random search}
	\end{minipage}
\end{figure}
...
\begin{figure}
    \begin{minipage}{0.45\textwidth}
    \centering
	\includegraphics[scale=0.37]{images/unique_random_remove.pdf} 
    \caption{unique random remove}
	\end{minipage}
	\hspace{0.5cm}
	\begin{minipage}{0.45\textwidth}
	\centering
	\includegraphics[scale=0.37]{images/unique_random_remove_numNodes.pdf} 
    \caption{unique random remove numNodes}
	\end{minipage}
\end{figure}
